...
export const GetPredictPanel = ({
  ...
  return (
    <div className="w-full h-auto flex flex-col dark:bg-neutral-800 dark:text-neutral-200 bg-neutral-200 text-neutral-800 p-1">
      <div className="w-full mb-1 h-auto flex-col flex lg:flex-row md:flex-col sm:flex-col">
        ...
        <button
          onClick={MonthPeriod}
          type="button"
          className="transition-all duration-500 border-2 border-neutral-300 dark:border-neutral-700 h-full m-1 p-1 dark:bg-neutral-700  dark:text-neutral-300 bg-neutral-300 text-neutral-700 rounded-full dark:hover:bg-neutral-300  dark:hover:text-neutral-700 hover:bg-neutral-700 hover:text-neutral-300 hover:text-base sm:w-full md:w-full lg:w-auto"
        >
          на месяц
        </button>
      </div>
      <div className="w-full h-auto flex flex-wrap">
        <PlacePredictPanel interval={interval} city = {city}/>
      </div>
    </div>
  );
};
